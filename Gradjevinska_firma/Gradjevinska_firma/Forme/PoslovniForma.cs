...
{
    public partial class PoslovniForma : Form
    {
        public PoslovniForma()
        {
            InitializeComponent();
        }
        ...
        public void popuniPodacima()
        {
            ...
            List<PoslovniPregled> lista = ProjekatDTOManager.vratiSvePoslovne();

            foreach (PoslovniPregled i in lista)
            {
        ...
        private void PoslovniForma_Load(object sender, EventArgs e)
        {
            popuniPodacima();
        }
        ...
        {
            using (DodajPoslovniForma forma = new DodajPoslovniForma())
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            using (IzmeniPoslovniForma forma = new IzmeniPoslovniForma(id))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    popuniPodacima();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            DetaljiPoslovniForma forma = new DetaljiPoslovniForma(id);
            forma.ShowDialog();
        }
    }
}
