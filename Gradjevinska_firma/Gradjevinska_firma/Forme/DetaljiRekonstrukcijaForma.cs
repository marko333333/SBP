...
{
    public partial class DetaljiRekonstrukcijaForma : Form
    {
        private int idRekonstrukcija;
        public DetaljiRekonstrukcijaForma(int idRekonstrukcija)
        {
            InitializeComponent();
        ...
        {
            ProjekatBasic projekat = ProjekatDTOManager.vratiProjekat(idRekonstrukcija);
        ...
        private void DetaljiRekonstrukcijaForma_Load(object sender, EventArgs e)
        {
            popuniPodacima();
        }
        ...
        private void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                List<NabavkeBasic> nabavke = NabavkeDTOManager.vratiNabavkeProjekta(idRekonstrukcija);
                popuniPodacimaNabavke(nabavke);

            }
            else if (tabControl1.SelectedIndex == 2)
            {
                List<BezbednosniIncidentBasic> bezbednosniIncidenti = BezbednosniIncidentDTOManager.vratiBezbednosniIncidenteProjekta(idRekonstrukcija);
                popuniPodacimaBezbednosnihIncidenta(bezbednosniIncidenti);
            }
            else if (tabControl1.SelectedIndex == 3)
            {
                List<FakturaBasic> fakture = FakturaDTOManager.vratiFaktureProjekta(idRekonstrukcija);
                popuniPodacimaFakture(fakture);
            }
            else if (tabControl1.SelectedIndex == 4)
            {
                List<FazaBasic> faze = FazaDTOManager.vratiFazeProjekta(idRekonstrukcija);
        ...
        {
            using (DodajBezbednosniIncidentForma forma = new DodajBezbednosniIncidentForma(idRekonstrukcija))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    List<BezbednosniIncidentBasic> incidenti = BezbednosniIncidentDTOManager.vratiBezbednosniIncidenteProjekta(idRekonstrukcija);
        ...
        private void btnIzmeni_Click(object sender, EventArgs e)
        {
            ...
            using (IzmeniBezbednosniIncidentForma forma = new IzmeniBezbednosniIncidentForma(id, idRekonstrukcija))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    List<BezbednosniIncidentBasic> incidenti = BezbednosniIncidentDTOManager.vratiBezbednosniIncidenteProjekta(idRekonstrukcija);
        ...
        private void btnObrisi_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                List<BezbednosniIncidentBasic> inc = BezbednosniIncidentDTOManager.vratiBezbednosniIncidenteProjekta(idRekonstrukcija);
        ...
        {
            using (DodajFakturuForma forma = new DodajFakturuForma(idRekonstrukcija))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    List<FakturaBasic> fakture = FakturaDTOManager.vratiFaktureProjekta(idRekonstrukcija);
        ...
        private void btnIzmeniFakturu_Click(object sender, EventArgs e)
        {
            ...
            using (IzmeniFakturuForma forma = new IzmeniFakturuForma(id, idRekonstrukcija))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    List<FakturaBasic> fak = FakturaDTOManager.vratiFaktureProjekta(idRekonstrukcija);
        ...
        {
            using (DodajFazuForma forma = new DodajFazuForma(idRekonstrukcija))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    List<FazaBasic> faze = FazaDTOManager.vratiFazeProjekta(idRekonstrukcija);
        ...
        private void btnIzmeniFazu_Click(object sender, EventArgs e)
        {
            ...
            using (IzmeniFazuForma forma = new IzmeniFazuForma(id, idRekonstrukcija))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    List<FazaBasic> faz = FazaDTOManager.vratiFazeProjekta(idRekonstrukcija);
        ...
        {
            using (DodajNabavkuProjektaForma forma = new DodajNabavkuProjektaForma(idRekonstrukcija))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    List<NabavkeBasic> nab = NabavkeDTOManager.vratiNabavkeProjekta(idRekonstrukcija);
        ...
        private void btnIzmeniNabavku_Click(object sender, EventArgs e)
        {
            ...
            using (IzmeniNabavkuProjektaForma forma = new IzmeniNabavkuProjektaForma(id, idRekonstrukcija))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    List<NabavkeBasic> nab = NabavkeDTOManager.vratiNabavkeProjekta(idRekonstrukcija);
