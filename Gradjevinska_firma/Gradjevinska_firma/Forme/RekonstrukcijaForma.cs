...
{
    public partial class RekonstrukcijaForma : Form
    {
        public RekonstrukcijaForma()
        {
            InitializeComponent();
        }
        ...
        private void RekonstrukcijaForma_Load(object sender, EventArgs e)
        {
            popuniPodacima();
        }
        ...
        {
            using (DodajRekonstrukcijaForma forma = new DodajRekonstrukcijaForma())
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            using (IzmeniRekonstrukcijaForma forma = new IzmeniRekonstrukcijaForma(id))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    popuniPodacima();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            DetaljiRekonstrukcijaForma forma = new DetaljiRekonstrukcijaForma(id);
            forma.ShowDialog();
        }
    }
}
