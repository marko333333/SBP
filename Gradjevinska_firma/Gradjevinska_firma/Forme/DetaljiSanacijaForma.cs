...
{
    public partial class DetaljiSanacijaForma : Form
    {
        private int idSanacija;
        public DetaljiSanacijaForma(int idSanacija)
        {
            InitializeComponent();
        ...
        {
            ProjekatBasic projekat = ProjekatDTOManager.vratiProjekat(idSanacija);
        ...
        private void DetaljiSanacijaForma_Load(object sender, EventArgs e)
        {
            popuniPodacima();
        }
        ...
        private void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                List<NabavkeBasic> nabavke = NabavkeDTOManager.vratiNabavkeProjekta(idSanacija);
                popuniPodacimaNabavke(nabavke);

            }
            else if (tabControl1.SelectedIndex == 2)
            {
                List<BezbednosniIncidentBasic> bezbednosniIncidenti = BezbednosniIncidentDTOManager.vratiBezbednosniIncidenteProjekta(idSanacija);
                popuniPodacimaBezbednosnihIncidenta(bezbednosniIncidenti);
            }
            else if (tabControl1.SelectedIndex == 3)
            {
                List<FakturaBasic> fakture = FakturaDTOManager.vratiFaktureProjekta(idSanacija);
                popuniPodacimaFakture(fakture);
            }
            else if (tabControl1.SelectedIndex == 4)
            {
                List<FazaBasic> faze = FazaDTOManager.vratiFazeProjekta(idSanacija);
        ...
        {
            using (DodajBezbednosniIncidentForma forma = new DodajBezbednosniIncidentForma(idSanacija))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    List<BezbednosniIncidentBasic> incidenti = BezbednosniIncidentDTOManager.vratiBezbednosniIncidenteProjekta(idSanacija);
        ...
        private void btnIzmeni_Click(object sender, EventArgs e)
        {
            ...
            using (IzmeniBezbednosniIncidentForma forma = new IzmeniBezbednosniIncidentForma(id, idSanacija))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    List<BezbednosniIncidentBasic> incidenti = BezbednosniIncidentDTOManager.vratiBezbednosniIncidenteProjekta(idSanacija);
        ...
        private void btnObrisi_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                List<BezbednosniIncidentBasic> inc = BezbednosniIncidentDTOManager.vratiBezbednosniIncidenteProjekta(idSanacija);
        ...
        {
            using (DodajFakturuForma forma = new DodajFakturuForma(idSanacija))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    List<FakturaBasic> fakture = FakturaDTOManager.vratiFaktureProjekta(idSanacija);
        ...
        private void btnIzmeniFakturu_Click(object sender, EventArgs e)
        {
            ...
            using (IzmeniFakturuForma forma = new IzmeniFakturuForma(id, idSanacija))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    List<FakturaBasic> fak = FakturaDTOManager.vratiFaktureProjekta(idSanacija);
        ...
        {
            using (DodajFazuForma forma = new DodajFazuForma(idSanacija))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    List<FazaBasic> faze = FazaDTOManager.vratiFazeProjekta(idSanacija);
        ...
        private void btnIzmeniFazu_Click(object sender, EventArgs e)
        {
            ...
            using (IzmeniFazuForma forma = new IzmeniFazuForma(id, idSanacija))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    List<FazaBasic> faz = FazaDTOManager.vratiFazeProjekta(idSanacija);
        ...
        {
            using (DodajNabavkuProjektaForma forma = new DodajNabavkuProjektaForma(idSanacija))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    List<NabavkeBasic> nab = NabavkeDTOManager.vratiNabavkeProjekta(idSanacija);
        ...
        private void btnIzmeniNabavku_Click(object sender, EventArgs e)
        {
            ...
            using (IzmeniNabavkuProjektaForma forma = new IzmeniNabavkuProjektaForma(id, idSanacija))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    List<NabavkeBasic> nab = NabavkeDTOManager.vratiNabavkeProjekta(idSanacija);
