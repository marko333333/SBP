...
{
    public partial class StambeniForma : Form
    {
        public StambeniForma()
        {
            InitializeComponent();
        }
        ...
        public void popuniPodacima()
        {
            ...
            List<StambeniPregled> lista = ProjekatDTOManager.vratiSveStambene();

            foreach (StambeniPregled i in lista)
            {
        ...
        private void StambeniForma_Load(object sender, EventArgs e)
        {
            popuniPodacima();
        }
        ...
        {
            using (DodajStambeniForma forma = new DodajStambeniForma())
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            using (IzmeniStambeniForma forma = new IzmeniStambeniForma(id))
            {
                if (forma.ShowDialog() == DialogResult.OK)
                {
                    popuniPodacima();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            DetaljiStambeniForma forma = new DetaljiStambeniForma(id);
            forma.ShowDialog();
        }
    }
}
